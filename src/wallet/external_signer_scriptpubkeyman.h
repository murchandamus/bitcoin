...
class ExternalSignerScriptPubKeyMan : public DescriptorScriptPubKeyMan
{
  ...
  */
  ...
  bool DisplayAddress(const CScript scriptPubKey, const ExternalSigner &signer);

  TransactionError FillPSBT(PartiallySignedTransaction& psbt, const PrecomputedTransactionData& txdata, int sighash_type = 1 /* SIGHASH_ALL */, bool sign = true, bool bip32derivs = false, int* n_signed = nullptr, bool finalize = true) override;
};
} // namespace wallet
