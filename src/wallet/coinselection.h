...
/**
 * Youngest first selector picks UTXOs from lowest confirmation count to highest confirmation count. If max weight is exceeded, kick out smallest effective value UTXO.
 *
