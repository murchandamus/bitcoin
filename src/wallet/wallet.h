...
//! -maxtxfee default
constexpr CAmount DEFAULT_TRANSACTION_MAXFEE{5 * COIN / 1000};
//! Discourage users to set fees higher than this amount (in satoshis) per kB
constexpr CAmount HIGH_TX_FEE_PER_KB{2 * COIN / 1000};
//! -maxtxfee will warn if called with a higher fee than this amount (in satoshis)
constexpr CAmount HIGH_MAX_TX_FEE{2 * DEFAULT_TRANSACTION_MAXFEE};
